  ...
  return (
    <div className="flex flex-col h-screen pt-20 items-center">
      ...
      <div className={`flex w-full justify-center mb-12 ${animationLoaded ? 'fade-in' : ''}`}>
        <a href="/compliance" className="bg-white rounded-lg py-8 px-10 w-1/4 mr-4 text-center">Track your compliance</a>
        <div className="w-1/6"></div>
        <a href="/residents" className="bg-white rounded-lg py-8 px-10 w-1/4 text-center">Manage residents and move-ins</a>
      </div>
      <div className={`flex w-full justify-center ${animationLoaded ? 'fade-in' : ''}`}>
        <a href="/tasks" className="bg-white rounded-lg py-8 px-10 w-1/4 mr-4 text-center">Manage and review personal tasks</a>
        <div className="w-1/6"></div>
        <a href="/analytics" className="bg-white rounded-lg py-8 px-10 w-1/4 text-center">Analytics</a>
      </div>
    </div>
  );
};
